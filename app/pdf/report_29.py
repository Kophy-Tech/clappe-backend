...
def add_another_page(pdf, item_list, currency, document, document_type):
    ...
    pdf.drawImage("app/pdf/logo_29_table.png", 5, -20, width=width-70, height=70)
...
def total_box(pdf, start_y, currency, document_type, document):
    fill_colour = colors.Color(233/255, 162/255, 176/255)
    width = pdf._pagesize[0]
    pdf.drawImage("app/pdf/logo_29_down.png", -35, 595, width=width+10, height=220)
    ...
    pdf.drawImage("app/pdf/logo_29_total.png", 340, start_y+95, width=100, height=50)
...
def get_report_29(buffer, document, currency, document_type, request, logo):
    ...
    pdf.drawImage("app/pdf/logo_29_up.png", -30, -30, width=width, height=400)
