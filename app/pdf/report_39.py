...
def add_another_page(pdf, item_list, currency, document, document_type):
    ...
    pdf.drawImage("app/pdf/logo_39.png", -30, -30, width=185, height=850)

    bold_color = colors.Color(128/255, 0, 129/255)
    stroke_color = colors.Color(237/255, 160/255, 169/255)
...
def get_report_39(buffer, document, currency, document_type, request, logo):
