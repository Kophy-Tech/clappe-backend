...
def get_report_15(buffer, document, currency, document_type, request):
    ...
    pdf.setFont('Helvetica', 10)
    pdf = draw_wrapped_line(pdf, document["customer"]["address"].capitalize(), 100, 10, 50, 10)
    pdf = draw_wrapped_line(pdf, document["customer"]["email"], 100, 10, 65, 10)
    pdf = draw_wrapped_line(pdf, document["customer"]["phone_number"], 100, 10, 80, 10)
